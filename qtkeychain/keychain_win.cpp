...
namespace {
    constexpr std::wstring_view PRODUCT_NAME = L"QtKeychain";
    constexpr std::wstring_view ENCRYPED_DATA_KEY = L"QtKeychain-encrypted data";
    constexpr std::wstring_view ATTRIBUTE_KEY = L"QtKeychain Attrib";
