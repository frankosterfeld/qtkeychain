...
KeyChainClass::KeyChainClass(QObject *parent)
    : QObject(parent),
      m_readCredentialJob(nullptr),
      m_writeCredentialJob(nullptr),
      m_deleteCredentialJob(nullptr)
{
}
...
void KeyChainClass::setService(const QString &service)
{
    ...
    m_writeCredentialJob = new QKeychain::WritePasswordJob(service, this);
    m_deleteCredentialJob = new QKeychain::DeletePasswordJob(service, this);
